...
AMyAIController::AMyAIController()
{
	...
	MeleeBox->OnComponentBeginOverlap.AddDynamic(this, &AMyAIController::MeleeHit);
	MeleeBox->SetupAttachment(RootComponent);

	DashMeleeBox = CreateDefaultSubobject<UBoxComponent>(TEXT("DashCollider"));
	DashMeleeBox->OnComponentBeginOverlap.AddDynamic(this, &AMyAIController::DashHit);
...
void AMyAIController::BeginPlay()
{
	...
	//EnemyFOVSphere->OnComponentBeginOverlap.AddDynamic(this, &AMyAIController::SphereOverlap);
	//EnemyFOVSphere->OnComponentEndOverlap.AddDynamic(this, &AMyAIController::SphereOverlapEnd);
}
...
void AMyAIController::CloseMeleeAttack(float DeltaTime)
{
...
void AMyAIController::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	Super::SetupPlayerInputComponent(PlayerInputComponent);

}

void AMyAIController::MeleeHit(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComponent, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
/*void AMyAIController::SphereOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComponent, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
/*void AMyAIController::SphereOverlapEnd(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComponent, int32 OtherBodyIndex)
{
	PlayerUnit = Cast<APlayerUnit>(OtherActor);
...
void AMyAIController::DashMeleeAttack(float DeltaTime)
{
...
void AMyAIController::DashHit(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComponent, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
float AMyAIController::PlayerDistance()
{
	return 0.0f;
}